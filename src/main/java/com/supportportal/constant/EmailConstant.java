...
public class EmailConstant {
    ...
    public static final String USERNAME = "hajarelkhiri123@gmail.com";
    public static final String PASSWORD = "bdtokirskexmoeqt";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Capgemini Accounts, LLC - New Password";
